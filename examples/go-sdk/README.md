...
Demonstrates different authentication methods (kubeconfig, in-cluster, token, gRPC).

**Learn:** Authentication patterns, RBAC, tokens, in-cluster config
...
Used in: `basic-workflow/`, `watch-workflow/`, `workflow-template/`, `authentication/`
