...
func (cred *ossCredentials) GetAccessKeyID() string {
	...
	if err != nil {
		// TODO: fix this TODO context
		cred.logger.WithField("err", err).Info(context.TODO(), "get access key id failed")
		return ""
	}
...
func (cred *ossCredentials) GetAccessKeySecret() string {
	...
	if err != nil {
		// TODO: fix this TODO context
		cred.logger.WithField("err", err).Info(context.TODO(), "get access key secret failed")
		return ""
	}
...
func (cred *ossCredentials) GetSecurityToken() string {
	...
	if err != nil {
		// TODO: fix this TODO context
		cred.logger.WithField("err", err).Info(context.TODO(), "get access security token failed")
		return ""
	}
