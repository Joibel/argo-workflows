...
# Telemetry Go files (metrics_list.go, attributes.go, metrics_helpers.go) are
# generated via go generate (see util/telemetry/generate.go), run as part of codegen.
